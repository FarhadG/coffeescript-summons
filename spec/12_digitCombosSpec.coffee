...
describe "Digit Combinations", ->
  ...
  it "returns the sorted combinations of a 2 digit number", ->
    expect(digitCombos(12)).to.eql([12, 21])
    
  it "returns the combinations of a 3 digit number", ->
    expect(digitCombos(123)).to.eql([123, 132, 213, 231, 312, 321])

  it "returns the combinations of a 4 digit number", ->
    expect(digitCombos(1234)).to.eql([1234, 1243, 1324, 1342, 1423, 1432, 
                                      2134, 2143, 2314, 2341, 2413, 2431, 
                                      3124, 3142, 3214, 3241, 3412, 3421, 
                                      4123, 4132, 4213, 4231, 4312, 4321])
  
  it "returns the combinations of a 5+ digit number", ->
